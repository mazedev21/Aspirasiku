...
@media screen and (max-width: 600px) {
	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM aspirasi INNER JOIN siswa ON aspirasi.nis=siswa.nis AND aspirasi.kategori='hubungan masyarakat' INNER JOIN tanggapan ON aspirasi.id_aspirasi=tanggapan.id_aspirasi INNER JOIN petugas ON tanggapan.id_petugas=petugas.id_petugas ORDER BY tanggapan.id_aspirasi DESC");
