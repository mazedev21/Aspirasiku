...
@media screen and (max-width: 600px) {
	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM aspirasi INNER JOIN siswa ON aspirasi.nis=siswa.nis WHERE aspirasi.status='proses' AND aspirasi.kategori='sarana dan prasarana' ORDER BY aspirasi.id_aspirasi DESC");
